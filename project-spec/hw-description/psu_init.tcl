...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01010F00
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD080124 0xFFFFFFFF 0x00381009
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180048 0x000000FE 0x00000020
    ...
    mask_write 0XFF18004C 0x000000FE 0x00000020
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x55040002
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x0033E000
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01F00000
